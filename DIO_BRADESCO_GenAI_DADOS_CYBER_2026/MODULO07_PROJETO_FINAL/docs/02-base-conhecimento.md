...
> Tenho estes arquivos de dados: [lista de arquivos].
> Me ajude a:
...
| Arquivo | Formato | Para que serve na Beta? |
|---------|---------|---------------------|
...
O produto Fundo Imobiliário (FII) substituiu o Fundo Multimercado, pois pessoalmente me sinto mais confiante em usar apenas produtos financeiros que eu conheço. Assim, poderei validar as respostas da Beta de forma mais assertiva.
...
O exemplo de contexto mostrado abaixo, se baseia nos dados originais da base de conhecimento, mas os sintetizam deixando apenas as informações mais relevantes, otimizando assim o consumo de tokens. Entretanto, vale lembrar que mais importante do que economizar tokens, é ter todas as informações relevantes disponíveis em seu contexto.
